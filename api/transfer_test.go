...
import (
	...
	mockdb "github.com/maan19/bank-app-go/db/mock"
...
func TestCreateTransfer(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupAuth: func(t *testing.T, request *http.Request, tokenMaker token.Maker) {
				addAuthorization(t, request, tokenMaker, authorizationTypeBearer, user1, 15*time.Minute)
			},
			buildStubs: func(store *mockdb.MockStore) {
		...
		},
		{
			...
			setupAuth: func(t *testing.T, request *http.Request, tokenMaker token.Maker) {
				addAuthorization(t, request, tokenMaker, authorizationTypeBearer, user3, 15*time.Minute)
			},
			buildStubs: func(store *mockdb.MockStore) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			data, errr := json.Marshal(tc.body)
